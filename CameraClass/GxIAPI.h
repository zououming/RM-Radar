...
{
    GX_AWB_LAMP_HOUSE_ADAPTIVE                     = 0,           ///< Adaptive light source自适应光源
    GX_AWB_LAMP_HOUSE_D65                          = 1,           ///< Color temperature 6500k色温6500K
    GX_AWB_LAMP_HOUSE_FLUORESCENCE                 = 2,           ///< Fluorescent荧光
    GX_AWB_LAMP_HOUSE_INCANDESCENT                 = 3,           ///< Incandescent白炽灯
